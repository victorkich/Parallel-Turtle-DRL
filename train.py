...
if __name__ == "__main__":
    ...
    p = torch_mp.Process(target=agent_worker, args=(config, copy.deepcopy(policy_net_cpu) if config['recurrent_policy']
                                                    and config['replay_memory_prioritized'] else target_policy_net,
                                                    None, global_episode, 0, "exploitation", experiment_dir,
